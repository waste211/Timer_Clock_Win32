...
// Check-box
WCHAR sOnMonday[MAX_LOADSTRING];
WCHAR sOnTuesday[MAX_LOADSTRING];
WCHAR sOnWednesday[MAX_LOADSTRING];
WCHAR sOnThursday[MAX_LOADSTRING];
WCHAR sOnFriday[MAX_LOADSTRING];
WCHAR sOnSaturday[MAX_LOADSTRING];
WCHAR sOnSunday[MAX_LOADSTRING];
// Btn
...
WCHAR sChooseDayBtn[MAX_LOADSTRING];
// main menu strings
